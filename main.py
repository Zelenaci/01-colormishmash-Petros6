...
class Application(tk.Tk):
    ...
    def __init__(self):
        ...
        self.entryMain.pack()
        self.btnExit = tk.Button(self, text="Exit", command=self.quit)
        self.btnExit.pack()
        self.btnChange = tk.Button(self, text="Change", command=self.change)
        self.btnChange.pack()
    ...
    def load(self):
        try:
            ...
            print("Soubor pro konfiguraci nebyl nalezen")
